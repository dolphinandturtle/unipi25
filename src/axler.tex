...
\begin{multicols}{3}
  ...
  \myparagraph{Addition} \textit{Element pair} mapping into an element.
  \myparagraph{Scalar multiplication} \textit{Scalar, element pair} mapping into an element.
  ...
  \myparagraph{Real} A vector space with scalar multiplication defined over the reals.
  \myparagraph{Complex} A vector space with scalar multiplication defined over the complex.
